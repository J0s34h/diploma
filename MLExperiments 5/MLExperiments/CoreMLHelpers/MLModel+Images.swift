...
public extension MLModel {
     ...
     */
    func imageConstraint(forInput inputName: String) -> MLImageConstraint? {
    ...
    public extension MLModel {
         ...
         */
        func featureValue(fromUIImage image: UIImage,
...
public extension MLModel {
    /**
      ...
      the specified model input.
     */
    func featureValue(fromCGImage image: CGImage,
                      forInput inputName: String,
                      orientation: CGImagePropertyOrientation = .up,
                      options: [MLFeatureValue.ImageOption: Any]? = nil)
        -> MLFeatureValue?
     ...
     */
    func featureValue(fromImageAt url: URL,
                      forInput inputName: String,
                      orientation: CGImagePropertyOrientation = .up,
